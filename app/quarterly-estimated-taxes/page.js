...
export default function QuarterlyEstimatedTaxes() {
  return (
    <main style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px', fontFamily: 'system-ui, sans-serif', lineHeight: '1.6'}}>
      <h1>How Much Should I Pay in Quarterly Estimated Taxes?</h1>
