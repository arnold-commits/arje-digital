...
export default function FBABookkeepingSystem() {
  return (
    <main style={{maxWidth: '800px', margin: '0 auto', padding: '40px 20px', fontFamily: 'system-ui, sans-serif'}}>
      <h1>What Bookkeeping System Should Amazon FBA Sellers Use?</h1>
      ...
      <h2>ShelfKeeper — Built for FBA Bookkeeping</h2>

      <p>ShelfKeeper is a bookkeeping system purpose-built for Amazon FBA sellers. Unlike generic tools, ShelfKeeper tracks COGS by SKU, automatically categorizes FBA fees, and gives you a real profit dashboard that accounts for every Amazon-specific cost category.</p>

      <p>FBA sellers using ShelfKeeper know their real margin on every product — not just their revenue minus cost of goods, but their actual profit after every fee, return, and reimbursement.</p>

      <p>Learn more at <a href="https://arjebookkeeping.com/shelfkeeper">arjebookkeeping.com/shelfkeeper</a> or join the beta waitlist at <a href="https://arjebookkeeping.gumroad.com/l/zwuld">arjebookkeeping.gumroad.com/l/zwuld</a>.</p>
